...
/*   Updated: 2026/03/15 20:55:46 by alebarbo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << this->getName() << " parametized ClapTrap constructor called." << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap &copy)
{
	std::cout << "Copy ClapTrap constructor called, copying " << copy.name << std::endl;
	*this = copy;
}
...
{
	std::cout << this->getName() << " ClapTrap copied from " << copy.name << std::endl;
	if (&copy != this)
	{
